...
class CfgVehicles {
	...
	class BWplus_Box_Cargo: B_CargoNet_01_ammo_F {
    	...
    	maximumload = 4000;
		class eventHandlers {
			Init = "[(_this select 0), 1] call BWplus_main_fnc_addRavenBAckpack; [(_this select 0), 'tf_rt1523g_big_bwmod', 1] call BWplus_main_fnc_addTFRbackpack;";
		};
	...
	*/
	...
	class BWplus_Offroad_Fldjgr: Offroad_01_base_F {
		...
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\offroad\fldjgr_co.paa)), QUOTE(PATHTOF(data\offroad\fldjgr_co.paa))};
		class eventHandlers {
		...
		class ACE_SelfActions: ACE_SelfActions {
			class BWplus_FlashOn {
			    ...
			    priority = 0.125;
			    distance = 5;
			    condition = "(vehicle ACE_player) animationPhase 'BeaconsStart' < 0.5 && {driver (vehicle ACE_player) == ACE_player}";
			    statement = "(vehicle ACE_player) animate ['BeaconsStart', 1]";
			    enableInside = 1;
	      	};
			class BWplus_FlashOff {
		    	...
		    	distance = 5;
			    condition = "(vehicle ACE_player) animationPhase 'BeaconsStart' > 0.5 && {driver (vehicle ACE_player) == ACE_player}";
			    statement = "(vehicle ACE_player) animate ['BeaconsStart', 0]";
			    enableInside = 1;
		    };	
	...
	class BWplus_Offroad_Standard: Offroad_01_base_F {
		...
		scopeCurator = 2;
		hiddenSelections[] = {"camo", "camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\offroad\offroad_co.paa)), QUOTE(PATHTOF(data\offroad\offroad_co.paa))};
	};
	...
	class BWplus_Wildcat: I_Heli_light_03_F {
		...
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\hellcat\hellcat_co.paa))};
		class TransportMagazines {
	...
	class BWplus_Merlin: I_Heli_Transport_02_F {
		...
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mohawk\mhawk1_co.paa)),QUOTE(PATHTOF(data\mohawk\mhawk2_co.paa)),QUOTE(PATHTOF(data\mohawk\mhawk3_co.paa))};
		class eventHandlers {
	...
	class BWplus_Fennek_Flecktarn: I_MRAP_03_F {
		...
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_fleck_fue_co.paa)),QUOTE(PATHTOF(data\mrap_fleck2_co.paa))};
	...
	class BWplus_Fennek_Flecktarn_pio: I_MRAP_03_F {
		...
		typicalCargo[] = {"BWA3_Rifleman_Fleck", "BWA3_Rifleman_Fleck"};
		hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_fleck_pio_co.paa)),QUOTE(PATHTOF(data\mrap_fleck2_co.paa))};
		transportMaxBackpacks = 3;
		transportMaxWeapons = 20;
    ...
    class BWplus_Fennek_Flecktarn_mg: I_MRAP_03_hmg_F {
		...
		crew = "BWA3_Rifleman_Fleck";
		hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_fleck_co.paa)),QUOTE(PATHTOF(data\mrap_fleck2_co.paa))};
		class TransportMagazines {
			MACRO_ADDMAGAZINE(BWA3_30Rnd_556x45_G36,10)
			MACRO_ADDMAGAZINE(BWA3_200Rnd_556x45,5)
			MACRO_ADDMAGAZINE(BWA3_DM51A1,5)
	...
	class BWplus_Fennek_Flecktarn_san: I_MRAP_03_F {
		...
		vehicleClass = "BWA3_VehClass_Wheeled_Fleck";
        hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_fleck_san_co.paa)),QUOTE(PATHTOF(data\mrap_fleck2_co.paa))};
	...
	class BWplus_Fennek_Tropen: BWplus_Fennek_Flecktarn {
		...
		hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_trop_fue_co.paa)),QUOTE(PATHTOF(data\mrap_trop2_co.paa))};
	};
	class BWplus_Fennek_Tropen_pio: BWplus_Fennek_Flecktarn_pio {
		...
		hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_trop_pio_co.paa)),QUOTE(PATHTOF(data\mrap_trop2_co.paa))};
	};
	class BWplus_Fennek_Tropen_mg: BWplus_Fennek_Flecktarn_mg {
		...
		crew = "BWA3_Rifleman_Tropen";
		hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_trop_co.paa)),QUOTE(PATHTOF(data\mrap_trop2_co.paa))};
	};	
	...
	class BWplus_Fennek_Tropen_san: BWplus_Fennek_Flecktarn_san {
        ...
        hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\mrap_trop_san_co.paa)),QUOTE(PATHTOF(data\mrap_trop2_co.paa))};
	};
	/*
    class Truck_F: Car_F {
