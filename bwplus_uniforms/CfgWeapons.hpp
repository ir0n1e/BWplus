class CfgWeapons {
    ...
    class BWplus_Cap_Green : H_Cap_red {
        ...
        picture = QUOTE(PATHTOF(data\bwplus_icon_capb_green_ca.paa));
        hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\bwplus_capb_green_co.paa))};
    };
    class BWplus_Cap_Sand : H_Cap_red {
        author = "BW.plus";
        displayName = "$STR_BWplus_Cap_Sand";
        picture = QUOTE(PATHTOF(data\bwplus_icon_capb_sand_ca.paa));
    ...
    class BWplus_Beret_Sani: BWA3_Beret_PzGren {
        ...
        picture = QUOTE(PATHTOF(ui\bwplus_beret_rot_x_ca.paa));
        hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\bwplus_beret_san_co.paa))};
    };
    class BWplus_Beret_Fldjgr: BWA3_Beret_PzGren {
        author = "BWA3 / BW.plus";
        displayName = "$STR_BWplus_uniforms_beretfldjgr";
        picture = QUOTE(PATHTOF(ui\bwplus_beret_rot_x_ca.paa));
        hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\bwplus_beret_fldjgr_co.paa))};
    };
    class BWplus_Beret_Pio: BWA3_Beret_PzGren {
        author = "BWA3 / BW.plus";
        displayName = "$STR_BWplus_uniforms_beretpio";
        picture = QUOTE(PATHTOF(ui\bwplus_beret_rot_x_ca.paa));
        hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\bwplus_beret_pio_co.paa))};
    };
    class BWplus_Beret_Frnmldr: BWA3_Beret_PzGren {
        author = "BWA3 / BW.plus";
        displayName = "$STR_BWplus_uniforms_beretfrnmldr";
        picture = QUOTE(PATHTOF(ui\bwplus_beret_rot_x_ca.paa));
        hiddenSelectionsTextures[] = {QUOTE(PATHTOF(data\bwplus_beret_frnmldr_co.paa))};
    };
};