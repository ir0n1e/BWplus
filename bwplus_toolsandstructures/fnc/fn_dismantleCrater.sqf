...
[_dismantletime, _this, "BWplus_dismantleCraterCallback", localize "STR_BWplus_toolsandstructures_DismantlingCrater", "BWplus_core_fnc_BuildAbort"] call AGM_Core_fnc_progressBar;
